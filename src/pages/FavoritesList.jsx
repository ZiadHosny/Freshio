        ...
        <div className='col-md-4'>
          ...
          <div className='d-flex shadow py-4'>
            <Stack className='col-md-6' direction="row" spacing={2}>
              <Avatar style={{ width: 100, height: 100, fontSize: 50 }} sx={{ bgcolor: "#0a472e" }}>KH</Avatar>
            </Stack>
          ...
          <div className=' py-5 my-5 shadow'>
            ...
            <div style={{ marginLeft: 5, fontSize: 35 }} className='d-flex align-items-center'>
              <BsFillPersonFill className='col-md-2'  />
              <h4 className='col-md-10'>User Profile</h4>
            </div>

            <div  style={{ marginLeft: 5, fontSize: 35 }} className='d-flex align-items-center my-4'>
